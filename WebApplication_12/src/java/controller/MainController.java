                ...
                if (action.equals("login")) {
                    ...
                    try {
                        ...
                        if (bookID == null || bookID.trim().isEmpty()){
                            checkError = true;
                            request.setAttribute("txtBookID_error", "Book ID can not be empty.");
                        }
                            
                        if (title == null || title.trim().isEmpty()){
                            checkError = true;
                            request.setAttribute("txtTitle_error", "Title can not be empty");
                        }
                        
                        if (author == null || author.trim().isEmpty()){
                            checkError = true;
                            request.setAttribute("txtAuthor_error", "Author can not be empty");
                        }
                        
                        if (publishYear < 0 || publishYear > 2025){
                            checkError = true;
                            request.setAttribute("txtPublishYear_error", "Publish Year >= 0 & <= 2025");
